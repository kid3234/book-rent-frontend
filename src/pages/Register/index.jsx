...
function Register() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      ...
      try {
        await axios.post("https://book-rent-api-4.onrender.com/api/V1/auth/register", data);
        navigate("/login");
      } catch (err) {
        console.log(err);
...
//       axios
//         .post("https://book-rent-api-4.onrender.com/api/V1/auth/register", data)
//         .then((res) => {
//           console.log(res);
//           navigate("/login");
//         })
...
//       <div className="w-1/2 min-h-screen flex flex-col gap-4 justify-center items-center">
//         <div className="sm:w-[100%] lg:w-[60%] h-fit p-2 lg:p-4 flex flex-col gap-4">
//           <div className="flex gap-4 ">
//             <svg
//               width="60"
//               height="33"
...
//     try {
//       const res = await axios.post("https://book-rent-api-4.onrender.com/api/V1/auth/register", data);
...
//                       name="email"
//                       sx={{ width: "100%" }}
//                       error={(formik) => formik.touched.email && Boolean(formik.errors.email)}
//                       helperText={(formik) => formik.touched.email && formik.errors.email}
//                     />
//                   </Box>
//                   <Box>
//                     <Field
...
//                       name="password"
//                       sx={{ width: "100%" }}
//                       error={(formik) => formik.touched.password && Boolean(formik.errors.password)}
//                       helperText={(formik) => formik.touched.password && formik.errors.password}
//                     />
//                   </Box>
//                   <Box>
//                     <Field
...
//                       name="cpassword"
//                       sx={{ width: "100%" }}
//                       error={(formik) => formik.touched.cpassword && Boolean(formik.errors.cpassword)}
//                       helperText={(formik) => formik.touched.cpassword && formik.errors.cpassword}
//                     />
//                   </Box>
//                   <Box>
//                     <Field
...
//                       name="location"
//                       sx={{ width: "100%" }}
//                       error={(formik) => formik.touched.location && Boolean(formik.errors.location)}
//                       helperText={(formik) => formik.touched.location && formik.errors.location}
//                     />
//                   </Box>
//                   <Box>
//                     <Field
...
//                       name="phone"
//                       sx={{ width: "100%" }}
//                       error={(formik) => formik.touched.phone && Boolean(formik.errors.phone)}
//                       helperText={(formik) => formik.touched.phone && formik.errors.phone}
//                     />
//                   </Box>
//                   <Box>
//                     <label>
