...
//       {/* Sidebar */}
//       <div
//         className={`bg-[#171B36] rounded-lg min-h-[90%] w-[240px] fixed top-10 md:top-16 md:left-2 text-[#FFFF] p-4 flex flex-col gap-8 z-50 transition-transform transform ${
